...
fontmake -g haskoy.glyphs -i -o ttf --output-dir ../fonts/ttf/static/
...
echo "Generating VFs"
fontmake -g haskoy.glyphs -o variable --output-path ../fonts/ttf/Haskoy\[ital,wght\].ttf

python gen_stat.py ../fonts/ttf/Haskoy\[ital,wght\].ttf
...
python set_italic.py ../fonts/ttf/Haskoy-Italic\[wght\].ttf
...
fontmake -g haskoy.glyphs -i -o otf --output-dir ../fonts/otf/
